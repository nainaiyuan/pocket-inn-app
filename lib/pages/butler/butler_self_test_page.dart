...
class _ButlerSelfTestPageState extends State<ButlerSelfTestPage> {
  ...
  static const List<(String, String)> _butlerSamples = [
    ...
    // 8-08 22:2x：'工具:list_tools' 原标 (应提示)——8-07 23:5x 用户
    // 一句话暗号设计后它是合法暗号（工具:名 无参）→ 应执行，改标
    ('暗号无参(应执行)', '工具:list_tools'),
    ('暗号带中文键(应执行)', '工具:manage_flow 动作=next'),
    ('方括号(应提示)', '[工具:list_tools]'),
    ('⟨工具未闭合(应提示)', '⟨工具:list_tools 我看看有哪些'),
    ('暗号后跟自然话(应提示)', '工具:list_tools 帮我看看有哪些'),
