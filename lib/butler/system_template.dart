...
**融合流程**：发现几个步骤/流程可以一起做 → manage_flow adjust
（adjust_action=merge，indices=[步骤编号]，name=合并后的步骤名），
合并后从头做；步骤顺序不对 → adjust_action=reorder（order=[新顺序]）。
对话里她说的几句话可以合成一件事记 → manage_chat_flow
