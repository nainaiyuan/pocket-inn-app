...
- record_memory：记住用户的喜好/习惯/约定/个人信息（必须带"category"类别：喜欢/讨厌/最爱→喜好；答应/约定→约定；每天/习惯→日常；名字/生日等事实→事实；其余→其他；带"keywords"关键词数组，把内容里的关键名词动词都提出来，如{"content":"妈妈喜欢猫","category":"喜好","keywords":["妈妈","喜欢","猫"]}，关键词越具体越好，找规律要用；content 写完整句子，原样保存）
